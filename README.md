...
- https://www.boot.dev/courses/build-web-scraper-python

## Ideas for Extending the Project
Make the script run on a timer and deploy it to a server. Have it email you every so often with the CSV report.
